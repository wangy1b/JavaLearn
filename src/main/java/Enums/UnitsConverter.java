...
public class UnitsConverter {
    ...
    public static void main(String[] args) {
        if(args.length == 0) {
            System.out.println("Usage: java UnitsConverter <wright in pounds>");
            System.exit(0);
        }
        ...
        System.out.printf("%s: %f%n",Converter.STONE, Converter.STONE.performConversion(numberToConvert));
